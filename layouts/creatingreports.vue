<template>
    <div>
      <header class="shadow-sm bg-dashboard-nav">
        <div class="">
          <nav class="container mx-auto pt-5 px-4 flex justify-between">
            <NuxtLink to="/"><h3 class="text-3xl text-dashboard-title">SpaceGen X</h3>
  </NuxtLink>
          ...
          <hr class="h-px mt-2 mb-8 border-gray-500 border-1" />
        </div>
      </header>
