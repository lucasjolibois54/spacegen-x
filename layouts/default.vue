  ...
  <div>
    <header class="shadow-sm bg-dashboard-nav ">
      <div class="container mx-auto">
        <nav
          class=" pt-5 md:ml-7 px-8 flex justify-between"
        >
        <div class="relative flex items-center">
            <!-- Input field -->
            <NuxtLink to="/"><h3 class="text-center text-3xl mt-2 hidden md:block text-dashboard-title">SpaceGen X</h3></NuxtLink>
