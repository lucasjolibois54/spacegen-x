  ...
  if (displayPage.value) {
    for (let i = 0; i < localStorage.length; i++) {
      ...
      if (key !== 'validUser') {
        ...
        // and either savedAsDraft property is false or doesn't exist
        if (storedData && storedData.email === user && (isDraft === false || isDraft === undefined)) {
...
<template>
    ...
    <div class="h-full bg-dark-bg flex">
        ...
        <div class="ml-20 md:ml-64 px-8 md:px-4 pb-8 w-full min-h-[calc(100vh-297px)]">
            <h2 class="text-3xl font-semibold text-dashboard-title mt-12 mb-6">All My Saved Reports</h2>
