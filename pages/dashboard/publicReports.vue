                ...
                <table class="min-w-full rounded-md shadow-sm">
                    ...
                    <tbody class="text-dark-data-text">
                         <tr v-for="report in reports" :key="report.id" class="border-b border-dark-btn-border hover:bg-dark-btn">
                            ...
                            <td class="px-4 py-2 hidden md:table-cell">{{ report.missionData.missionDescription.substring(0, 15) }}...</td>
                            <td class="px-4 py-2 hidden md:table-cell">
                            ...
                            <NuxtLink :to="`/dashboard/public-reports/${report.id}`"><td class="px-4 py-2">
                              <svg
                      fill="#CECFC2"
                      version="1.1"
                      id="Capa_1"
