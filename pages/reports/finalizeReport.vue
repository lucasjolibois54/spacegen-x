...
<template>
  <ProtectedPage>
    <div class="h-full bg-dark-bg flex">
      ...
      <!-- Main Content -->
      <div
        class="ml-20 md:ml-64 px-8 md:px-4 pb-8 w-full min-h-[calc(100vh-297px)]"
      >
        ...
        <section>
          <div class="mt-16">
            ...
            <h2 class="text-4xl font-semibold text-dashboard-title mb-0">
              {{ missionStore.missionName }}
            </h2>
          </div>
        </section>
        ...
        <div class="text-gray-300 mt-5">
          ...
          <div class="mt-10">
            <h2 class="text-2xl font-semibold mb-4 text-dashboard-title">
              Selected Images:
            </h2>
            <div
              class="grid grid-cols-2 md:grid-cols-4 gap-4"
              v-if="missionStore.missionImages.length"
            >
              <img
